...
Nesta base de dados conseguimos identificar 6 entidades, sendo elas o armazém, os produtos, as encomendas, o fornecedor, o tipo de fornecedor e as condições de pagamento.
Um armazém tem vários produtos que por sua vez têm encomendas. Estas têm um fornecedor, tendo este um tipo de fornecedor único bem como uma única condição de pagamento.
Abaixo são identificados os atributos de cada entidade :

Armazem : Codigo, Morada
PK : Codigo
FK(s) : (none)

Produtos: Codigo, Nome, Preço, IVA
PK: Codigo
FK(s): (none)

Encomendas: Numero, Data, Fornecedor_Codigo, Produto_Codigo, Quantidade
PK:Numero
FK(s): Fornecedor_Codigo, Produto_Codigo
...
Fornecedor: Codigo, Nome , Morada , NIF, Fax, CondicoesPagamento_Codigo , TipoFornecedor_Codigo
PK: Codigo
FK(s) : CondicoesPagamento_Codigo, TipoFornecedor_Codigo
...
```
    ...
    Quanto ao grau, todas as 5 relações são binárias.

    Quanto à cardinalidade:
        - Armazém tem produtos 1:N
        - Produtos têm encomendas N:M
        - Encomendas têm fornecedor N:1
        - Fornecedor tem tipo de fornecedor N:1
        - Fornecedor tem condição de pagamento N:1

    Quanto à obrigatoriedade:
        
        - Nem sempre o armazém tem o produto mas um produto tem sempre um armazém;
        - Nem sempre um produto é encomendado, ou seja, tem uma encomenda mas todas as encomendas têm produtos;
        - Uma encomenda tem sempre um fornecedor, mas nem sempre um fornecedor tem encomendas;
        - Um fornecedor tem sempre um tipo de fornecedor mas alguns tipos de fornecedor podem não ter fornecedores associados;
        - Um fornecedor tem sempre certas condições de pagamentos mas nem todas as condições de pagamento têm fornecedores associados.
